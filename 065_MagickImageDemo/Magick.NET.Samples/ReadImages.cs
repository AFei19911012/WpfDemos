...
public static class ReadImageSamples
{
    ...
    public static void ReadBasicImageInformation()
    {
        ...
        Debug.WriteLine(info.Width);
        Debug.WriteLine(info.Height);
        Debug.WriteLine(info.ColorSpace);
        Debug.WriteLine(info.Format);
        if (info.Density is not null)
        {
            Debug.WriteLine(info.Density.X);
            Debug.WriteLine(info.Density.Y);
            Debug.WriteLine(info.Density.Units);
        }
    }
