...
namespace WpfPlot3DDemo.Plot3D
{
	...
	/// Author      : BigWang
	/// Created Time: 2024/8/22 23:54:54
	/// Description :
	/// ----------------------------------------------------------------
	/// Version      Modified Time              Modified By     Modified Content
	/// V1.0.0.0     2024/8/22 23:54:54                     BigWang         首次编写         
	///
    public class ColorSchema
    {
        ...
        public ReadOnlyCollection<Color> Schema
        {
            get
            {
                ...
                return readOnlyCollectionSchema = Array.AsReadOnly(schema);
            }
        }

        public int Length => schema.Length;

        public Color this[int index] => schema[index];

        #endregion

        #region Constructors

        public ColorSchema(Color[] schema) => this.schema = schema;
        ...
        public ColorSchema(Color baseColor) => GenerateColorBasedSchema(baseColor);

        public ColorSchema(double baseHue) => GenerateHueBasedSchema(baseHue);

        #endregion

        #region Methods

        private void GenerateHueBasedSchema(double hue) => GenerateHueBasedSchema(hue, defaultSchemaLength);
        ...
        private void GenerateColorBasedSchema(Color col) => GenerateColorBasedSchema(col, defaultSchemaLength);
